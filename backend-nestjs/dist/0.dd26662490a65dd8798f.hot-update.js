...
let BlogsService = class BlogsService {
    ...
    async destroy(id) {
        ...
        for (const imgUrl of imagePaths) {
            const absolutePath = './uploads' + imgUrl.replace('http://localhost:8080', '');
            try {
                await (0, promises_1.unlink)(absolutePath);
                console.log(`Ảnh trong nội dung đã được xóa: ${absolutePath}`);
            }
            catch (error) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("5363c34b67e28136480e")
/******/ })();
/******/ 
/******/ }
;