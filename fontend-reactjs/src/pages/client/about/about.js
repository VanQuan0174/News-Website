...
import '../../../public/assets/client/assets/styles/page//about.scss';

function About() {
    return (
        <main class="main d-flex">
            <section class="main-desktop__section main__section--about d-flex ">
                <div class="section__nav d-flex">
                    <div class="section__nav-list d-flex">
                        <ul>
                            <li class="text-heading"><a href="/about">GIỚI THIỆU</a></li>
                        </ul>
                    </div>
                </div>
                <div class="section__content section__content--about d-flex">
                    <div class="about__title">
                        <h3>
                            Việc đưa Trang Thông tin đối ngoại điện tử đi vào hoạt động sẽ góp phần đa dạng hóa phương thức tuyên truyền, thông tin đối ngoại, tăng cường khai thác hiệu quả các nền tảng số, nền tảng internet, ứng dụng công nghệ truyền thông hiện đại để tăng tính lan tỏa, tính nhanh nhạy, chính xác và khả năng tương tác của thông tin đối ngoại.
                        </h3>
                    </div>
