...
const Login = () => {
    // Sử dụng state để lưu trữ giá trị email và password
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = response.data; // Dữ liệu từ response axios trả về nằm trong response.data
    ...
    return (
        <div className="card">
            ...
            <form onSubmit={handleSubmit}>
                ...
                {/* <button
                    className="btn-login "
                    onClick={() => navigate('/add-user')} // Điều hướng khi bấm
                >
                    Register
                </button> */}
